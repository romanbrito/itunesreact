...
// 4. When the Search button is clicked, make a call to the API and display the list of albums,
// including the album name and album cover inside #albums-container in a grid. Use any CSS technique
// you are comfortable with (Note: The API will return a list of albums based on the search result.
// Use your skills to find out what the iTunes API data structure looks like and extract the relevant data from it).
